...
# Building
Project is buildable using a dotnet 9 Environment on Windows, with no extra dependencies not available in a standard Desktop runtime. As of now, it is untested on both Linux and MacOS environments. 
